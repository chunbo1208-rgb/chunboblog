...
$$
(a_1+a_2+\cdots+a_n)(b_1+\cdots+b_n)>\frac29 n^3$$ And actually, the coefficient $2/9$ is the best. 
...
(a_1+a_2+\cdots+a_n)(b_1+\cdots+b_n)=\frac1{36}k^6=\frac29n^2
$$
...
So Here, $$\frac S{N}\le  \log \sqrt N + \log\log N - \log \log \sqrt N  $$ which can be easily derived to be $1 - \log 2$.
